...
import ScoresSvg from '../assets/img/marks.svg';
import ProfSvg from '../assets/img/scores.svg';
...
import SearchForm from './searchStudentForm';
      ...
      <div className="text-center">
        <Accordion style={{ width: '95%' }}>
          <Card style={{ borderRdius: 60 }}>
            ...
            >
              <span className="h6 pt-1 text-center">
                <FontAwesomeIcon icon={faUserPlus} /> Admit New Student
              </span>
            </Accordion.Toggle>
          ...
          <Card border="light" className="text-center">
            ...
            >
              <span className="h6 pt-1">
                <FontAwesomeIcon icon={faSearch} /> Search for Student
              </span>
            </Accordion.Toggle>
          ...
          <Card border="light" className="text-center">
            ...
            >
              <span className="h6 pt-1">
                <FontAwesomeIcon icon={faTrashAlt} /> Delete Student
              </span>
            </Accordion.Toggle>
      ...
      <div className={classes.root}>
        ...
        >
          ...
          >
            ...
            <Tab label="Students List" {...a11yProps(2)} />
          </Tabs>
        </AppBar>
        ...
        <TabPanel value={value} index={1}>
          <div>
                        ...
                        <div className="row">
                          <div className="col-lg-6 col-md-6 col-sm-6 col-xs-6 pr-0 pt-3">
                            <div className="card-content">
                              <h2 className="font-22">Scores</h2>
                    ...
                    <div className="card-statistic-4">
                      <div className="align-items-center justify-content-between">
                        <div className="row ">
                          <div className="col-lg-6 col-md-6 col-sm-6 col-xs-6 pr-0 pt-3">
                            <div className="card-content">
                              <h2 className="font-22">Predictive Analysis</h2>
            ...
            <h5 className="font-22 mt-4">Student Population</h5>
